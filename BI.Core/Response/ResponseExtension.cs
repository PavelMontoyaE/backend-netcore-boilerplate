...
public static class ResponseExtension
{
    ...
    public static Response ToResponseExeption(this Exception E, bool IsValid, HttpStatusCode Type,
        string Messages = "There was an error with function")
    {
        Response Response = new()
        {
            IsValid = IsValid,
